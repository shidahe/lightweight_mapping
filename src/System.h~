...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, bool bUseViewer = true);
    ...
    // System threads: Local Mapping, Loop Closing, Viewer, Local Meshing
