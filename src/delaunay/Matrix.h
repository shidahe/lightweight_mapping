...
// This header introduces the Matrix class.  It is a simple double-type
// Matrix class designed to be generally handy for c++ development or for
// porting simple MATLAB scripts.  It supports functions on vectors such as
// cross products.  It is a work in progress.
  ...
  class Matrix {
	public:
		...
		// TODO: add a constructor that takes a variable # of double arguments and returns a row-vector of those doubles.  Perhaps another one w/ a bool flag preceeding it.
              // does above idea conflict with constructor #2?
	...
	private:
		...
		#include "Matrix_vect_private.cc"
